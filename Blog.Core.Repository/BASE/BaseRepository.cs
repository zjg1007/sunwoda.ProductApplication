...
namespace Blog.Core.Repository.Base
{
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class, new()
    {
        ...
        public BaseRepository(IUnitOfWork unitOfWork)
        {
            ...
            // _context.CreateTableByEntity(false, new Interface_Log());
            //_context.CreateTableByEntity(false,new BlogArticle());
            //_context.CreateTableByEntity(false, new RoleModulePermission());
            //_context.CreateTableByEntity(false, new Role());
            //_context.CreateTableByEntity(false, new Module());
            //_context.CreateTableByEntity(false, new Permission());
            //_context.CreateTableByEntity(false, new sysUserInfo());
            //_context.CreateTableByEntity(false, new UserRole());
            //_db = _context.Db;
